...
/* One icon set for the whole app, drawn inline so nothing is fetched.
   24px grid, 2px round strokes — every glyph the UI needs lives here, so no
   view ever reaches for an emoji or a text arrow again. */
